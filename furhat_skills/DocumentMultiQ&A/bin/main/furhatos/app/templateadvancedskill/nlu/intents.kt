...
class AskForDocumentInfo : Intent() {
    override fun getExamples(lang: Language): List<String> {
        return listOf(
            "I want document info",
            "I'd like info about documents",
            "Tell me about my documents",
            "Give me document info"
        )
    }
}

class DocumentAIntent : Intent() {
    override fun getExamples(lang: Language): List<String> {
        return listOf(
            "Document A",
            "A doc",
